...
const InvestorProfile = async ({ params }: { params: Promise<{ username: string }> }) => {
  ...
  try {
    data = await profilesApi.getInvestorByUsername(username);
  } catch (error) {
          ...
          <div className="max-w-9xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
              ...
              <p className="text-lg mb-6" style={{ color: colors.textSecondary }}>
                The investor profile for "<strong>{username}</strong>" could not be found.
              </p>
              <p className="text-sm" style={{ color: colors.textMuted }}>
                This investor may not exist or may have a different username.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="min-h-screen mt-20 font-montserrat" style={{ backgroundColor: '#fafafa' }}>
          <div className="max-w-9xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
              ...
              <p className="text-lg mb-6" style={{ color: colors.textSecondary }}>
                The user "<strong>{username}</strong>" is not registered as an investor.
              </p>
              <p className="text-sm" style={{ color: colors.textMuted }}>
