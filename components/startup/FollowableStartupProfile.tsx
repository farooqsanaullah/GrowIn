        ...
        <div className="flex-1 space-y-6 overflow-y-auto">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            ...
            <button
              ...
              className={`px-5 py-2 text-sm font-semibold rounded-full shadow-md transition ${isFollowed ? "bg-gray-300 text-black" : "bg-blue-500 text-white"
                }`}
            >
              ...
              <div className="rounded-2xl p-6 shadow-md bg-gray-50">
                ...
                <div className="mb-6">
                  ...
                  <button
                    ...
                    className={`w-full mt-3 py-2 font-semibold rounded-lg transition ${isInvesting ? "bg-gray-400 cursor-not-allowed" : "bg-blue-500 hover:bg-blue-600 text-white"
                      }`}
                  >
              ...
              <div className="flex gap-2 justify-center mb-2">
                {[1, 2, 3, 4, 5].map(star => (
                  <Star
                    ...
                    className={`cursor-pointer transition ${userRating && star <= userRating
