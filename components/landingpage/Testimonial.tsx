...
const Testimonial = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      company: 'Independent',
      avatar: 'https://images.unsplash.com/photo-1463453091185-61582044d556?w=150&h=150&fit=crop&crop=face&auto=format',
  ...
  return (
    <section className="py-16 lg:py-24 overflow-hidden" style={{ backgroundColor: colors.bgPrimary + '30' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg sm:text-xl max-w-2xl mx-auto" style={{ color: colors.textSecondary }}>
            Hear from investors and founders who've found success through our platform
          </p>
        </div>
            ...
            >
              <div className="flex items-center mb-6">
                ...
                <div className="flex-1">
                  <h4 className="font-semibold text-lg" style={{ color: colors.textPrimary }}>
                    {testimonial.name}
                  </h4>
              ...
              <blockquote className="text-base leading-relaxed" style={{ color: colors.textMuted }}>
                "{testimonial.text}"
              </blockquote>

              <div className="mt-6 flex items-center gap-2">
                <div className="w-2 h-2 rounded-full" style={{ backgroundColor: colors.textPrimary }}></div>
      ...
      <div className="text-center mt-16">
        <div className="inline-flex items-center gap-4 px-6 py-3 rounded-full"
             style={{ backgroundColor: 'white', boxShadow: '0 4px 20px rgba(0,0,0,0.1)' }}>
          <div className="flex items-center gap-1">
            <span className="text-2xl">⭐</span>
            <span className="font-bold text-xl" style={{ color: colors.textPrimary }}>4.9</span>
          </div>
          <div className="w-px h-6" style={{ backgroundColor: colors.textMuted + '30' }}></div>
