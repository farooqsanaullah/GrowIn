  ...
  const investmentSteps = [
    {
      ...
      description:
        "Sign up and complete your investor profile in just 2 minutes",
    },
    {
      id: 2,
      icon: "🔍",
      ...
      description:
        "Explore verified startups across different industries and stages",
    },
    {
      id: 3,
      icon: "📊",
      ...
      description:
        "Review metrics, team info, and growth potential with AI insights",
    },
    {
      id: 4,
      icon: "💰",
    ...
    >
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          >
            Get started with startup investing in just four simple steps. No
            complex procedures, just straightforward investment opportunities.
          </p>
        </div>
            ...
            <div key={step.id} className="relative">
              ...
              {index < investmentSteps.length - 1 && (
                <div className="hidden lg:block absolute top-1/2 -right-6 transform -translate-y-1/2">
                  ...
                  >
                    <div
                      className="absolute right-0 top-1/2 transform -translate-y-1/2 w-0 h-0 border-l-4 border-r-0 border-t-2 border-b-2 border-transparent"
