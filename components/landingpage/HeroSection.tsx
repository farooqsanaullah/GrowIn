...
const HeroSection = () => {
  ...
  const featuredCompanies: CompanyCard[] = [
    {
      ...
      description: "Solar optimization platform participating in GrowIn's sustainability batch competition.",
      funding: "Batch Winner",
      logo: "ES",
      thumbnail: "https://images.unsplash.com/photo-1509391366360-2e959784a276?w=400&h=200&fit=crop",
      metrics: {
        investors: 24,
        funding_raised: "$2.5M",
        growth: "+340%"
    ...
    },
    {
      ...
      description: "Early disease detection platform connecting with investors through GrowIn's healthcare showcase.",
    ...
    },
    {
      ...
      description: "Blockchain payment infrastructure featured in GrowIn's fintech innovation competition.",
  ...
  return (
    <>
      ...
      <section className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 relative overflow-hidden pt-16 lg:pt-20" style={{ background: `linear-gradient(135deg, ${colors.bgPrimary}, ${colors.bgSecondary})` }}>
      {/* Background Pattern */}
      ...
      <div className="w-full max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center relative z-10 min-h-screen lg:min-h-0">
          {/* Left Content */}
          <div className="flex flex-col justify-center space-y-8 text-center lg:text-left py-8 lg:py-0" style={{ color: colors.textPrimary }}>
            <div className="space-y-6">
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-tight">
                AI-Powered Startup
                <span className="block text-transparent bg-clip-text" style={{ backgroundImage: `linear-gradient(135deg, ${colors.textPrimary}, ${colors.textSecondary})` }}>
                  Ecosystem
                </span>
              </h1>
              
              <p className="text-lg sm:text-xl leading-relaxed max-w-2xl mx-auto lg:mx-0" style={{ color: colors.textSecondary }}>
                Connect founders and investors in a single space. Discover startups, participate in competitions, 
                and build the <span className="font-semibold" style={{ color: '#10b981' }}>future of innovation</span>.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 lg:gap-8 pt-8 max-w-lg mx-auto lg:max-w-none lg:mx-0">
              <div className="text-center lg:text-left">
                <div className="text-2xl sm:text-3xl font-bold" style={{ color: colors.textPrimary }}>500+</div>
                <div className="text-sm font-medium" style={{ color: colors.textMuted }}>Startups</div>
              </div>
              <div className="text-center lg:text-left">
                <div className="text-2xl sm:text-3xl font-bold" style={{ color: colors.textPrimary }}>50+</div>
                <div className="text-sm font-medium" style={{ color: colors.textMuted }}>Active Competitions</div>
              </div>
              <div className="text-center lg:text-left">
                <div className="text-2xl sm:text-3xl font-bold" style={{ color: colors.textPrimary }}>1000+</div>
                <div className="text-sm font-medium" style={{ color: colors.textMuted }}>Founders & Investors</div>
              </div>
            </div>
          </div>
              ...
              return (
                <div
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.transform = `${transform.transform} scale(${transform.scale * 1.02})`;
                  }}
                  onMouseLeave={(e) => {
                ...
                >
                  {/* Card Content */}
                  <div className="h-full flex flex-col justify-between relative overflow-hidden" style={{ transform: 'translateZ(50px)' }}>
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="w-full h-24 sm:h-32 rounded-2xl mb-3 sm:mb-4 relative overflow-hidden group">
                        ...
                        <div className="absolute top-2 sm:top-3 right-2 sm:right-3">
                          <span 
                            ...
                            style={{ backgroundColor: company.badge_color + 'E6' }}
                          >
                            🏆 {company.funding}
                          </span>
                        </div>
                      ...
                      <div className="mb-3 sm:mb-4">
                        <h3 className="text-lg sm:text-xl font-bold mb-1 sm:mb-2" style={{ color: colors.textPrimary }}>
                          {company.name}
                        </h3>
                        <p className="font-semibold text-sm mb-2 sm:mb-3" style={{ color: colors.textSecondary }}>
                          {company.industry}
                        </p>
                      ...
                      <p className="leading-relaxed text-xs sm:text-sm mb-4 sm:mb-5" style={{ color: colors.textMuted }}>
                        {company.description}
                      </p>
                      
                      {/* Metrics Section */}
                      <div className="grid grid-cols-3 gap-2 sm:gap-4 mb-4 sm:mb-6">
                        <div className="text-center p-2 sm:p-3 rounded-lg" style={{ backgroundColor: colors.bgPrimary + '30' }}>
                          <div className="text-sm sm:text-lg font-bold" style={{ color: colors.textPrimary }}>
                        ...
                        <div className="text-center p-2 sm:p-3 rounded-lg" style={{ backgroundColor: colors.bgSecondary + '30' }}>
                          <div className="text-sm sm:text-lg font-bold" style={{ color: colors.textPrimary }}>
                        ...
                        <div className="text-center p-2 sm:p-3 rounded-lg" style={{ backgroundColor: '#10b98120' }}>
                          <div className="text-sm sm:text-lg font-bold" style={{ color: '#10b981' }}>
                    ...
                    {/* Footer */}
                    <div className="relative z-10">
                      <div className="flex justify-between items-center pt-3 sm:pt-4" style={{ borderTop: `1px solid ${colors.textMuted}30` }}>
                        ...
                        <button 
                          ...
                          onMouseLeave={(e) => {
                            e.currentTarget.style.backgroundColor = colors.bgPrimary + '50';
            ...
            <div className="absolute -bottom-12 sm:-bottom-16 left-1/2 transform -translate-x-1/2 flex gap-2 sm:gap-3">
              {featuredCompanies.map((_, index) => (
                <button
                  ...
                  style={{
                    backgroundColor: index === currentCard 
                      ? colors.textPrimary 
                      : colors.textMuted,
